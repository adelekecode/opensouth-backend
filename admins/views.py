...
class AdminDatasetDetails(APIView):
    ...
    def get(self, request, pk):
        try:
            ...
            return JsonResponse({"error": "dataset not found"}, status=status.HTTP_404_NOT_FOUND)
...
def dataset_actions(request, pk, action):
    ...
    if request.method == 'POST':
        ...
        if action is None:
            return JsonResponse({"error": "action is required"}, status=status.HTTP_400_BAD_REQUEST)
        
        try:
            dataset = Datasets.objects.get(id=pk)
        except Datasets.DoesNotExist:
            return JsonResponse({"error": "dataset does not exist"}, status=status.HTTP_404_NOT_FOUND)
        ...
        if action == "rejected":
            ...
            if remark is None:
                return JsonResponse({"error": "remark is required"}, status=status.HTTP_400_BAD_REQUEST) 
...
"""
            ...
            return JsonResponse({"message": "dataset rejected successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "dataset approved successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "dataset unpublished successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "dataset kept for further review successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "dataset deleted successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "organisation rejected successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "organisation approved successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "organisation blocked successfully"}, status=status.HTTP_200_OK)
...
"""
            ...
            return JsonResponse({"message": "organisation unblocked successfully"}, status=status.HTTP_200_OK)
            ...
            return JsonResponse({"message": "organisation deleted successfully"}, status=status.HTTP_200_OK)
...
def news_views(request, pk):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return JsonResponse({"error": "news does not exist"}, status=status.HTTP_404_NOT_FOUND)
        
        news.views += 1
        news.save()

        return JsonResponse({"message": "news views updated successfully"}, status=status.HTTP_200_OK)
...
def news_actions(request, pk, action):
    ...
    if request.method == 'POST':
        ...
        if action == "publish":
            ...
            return JsonResponse({"message": "news objectt updated successfully"}, status=status.HTTP_200_OK)
...
def organisation_request_actions(request, pk, action):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return JsonResponse({"error": "organisation request does not exist"}, status=status.HTTP_404_NOT_FOUND)
        ...
        if action == "reject":
            ...
            return JsonResponse({"message": "organisation request rejected successfully"}, status=status.HTTP_200_OK)
            ...
            return JsonResponse({"message": "organisation request approved successfully"}, status=status.HTTP_200_OK)
